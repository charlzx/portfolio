...
## Experience
- Freelance Frontend Developer | Self-Employed (2019 - Present)
  - Partnered with startups and small businesses to build and scale their web applications. Specialized in creating responsive, high-performance UIs with React and Next.js.
- UI/UX Intern | Innovate Solutions (2018)
  - Assisted the design team in creating wireframes, mockups, and prototypes. Contributed to the development of a new design system using Figma and Storybook.

## Certifications
- React - The Complete Guide | Udemy (Academind) (2020)
- Advanced CSS and Sass | Udemy (Jonas Schmedtmann) (2019)
`,
      'projects': {
...
`< ${message} >
 \\  ^__^
  ...
  return (
    <main className={`flex items-center justify-center min-h-screen sm:p-4 bg-gray-800/50 ${fontClass} ${sizeClass} ${themeClasses.text}`}>
