...
export default function ProjectDetailPage() {
  ...
  useEffect(() => {
    document.title = p ? `${p.name} — charlz.dev` : "Project — charlz.dev";
  }, [p]);

  if (!p) {
    return (
      <div style={{ padding: 80, fontFamily: "var(--font-hand)", fontSize: 24 }}>
        Project not found. <Link href="/projects">← back</Link>
      </div>
    );
  }
